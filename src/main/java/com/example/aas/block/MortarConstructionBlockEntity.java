...
import com.example.aas.config.AASConfig; // <-- Не забываем конфиг
...
public class MortarConstructionBlockEntity extends BlockEntity {
    ...
    public MortarConstructionBlockEntity(BlockPos pos, BlockState state) {
        // ВАЖНО: Используем тип MORTAR_CONSTRUCTION_BE
        super(ModBlocks.MORTAR_CONSTRUCTION_BE.get(), pos, state);
    }
